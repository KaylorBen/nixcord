...
import { ParsedPluginsResultSchema } from '../src/shared/types.js';
import { parsePlugins } from '../src/core/parser/index.js';
import { generateNixModule } from '../src/nix/generator.js';
import { validateParsedResults } from '../src/core/runner/index.js';
...
vi.mock('../src/cli/index.js', () => cliMocks);
vi.mock('../src/core/runner/index.js', async (orig) => ({ ...(await orig()) }));
