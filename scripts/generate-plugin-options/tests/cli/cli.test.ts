...
import { buildCli, runCli, handleCliError, CliExecutionError } from '../../src/cli/index.js';
import { runGeneratePluginOptions } from '../../src/core/runner/index.js';
...
vi.mock('../../src/core/runner/index.js', () => ({
