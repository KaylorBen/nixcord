import { z } from 'zod';
import type { ReadonlyDeep, Simplify, Exact } from 'type-fest';
...
export type PluginSettingRequired = Required<Pick<PluginSetting, 'name' | 'type'>> &
  Partial<Omit<PluginSetting, 'name' | 'type'>>;
