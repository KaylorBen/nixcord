      ...
      [
        {
          programs.nixcord = {
            discord.configDir = lib.mkDefault (
              let
                basePath = "${config.home.homeDirectory}/.config";
                branchDirName =
                  {
                    stable = "discord";
                    ptb = "discordptb";
            ...
            vesktop.configDir = lib.mkDefault "${config.home.homeDirectory}/.config/vesktop";
            equibop.configDir = lib.mkDefault "${config.home.homeDirectory}/.config/equibop";
            dorion.configDir = lib.mkDefault "${config.home.homeDirectory}/.config/dorion";
          };
        }
        {
