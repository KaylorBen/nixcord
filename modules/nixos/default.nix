    ...
    mkMerge ([
      {
        ...
        programs.nixcord.vesktop.configDir = lib.mkDefault "/home/${cfg.user}/.config/vesktop";
        programs.nixcord.equibop.configDir = lib.mkDefault "/home/${cfg.user}/.config/equibop";
        programs.nixcord.dorion.configDir = lib.mkDefault "/home/${cfg.user}/.config/dorion";
