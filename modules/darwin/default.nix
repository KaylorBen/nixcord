  ...
  config = mkIf config.programs.nixcord.enable (
    let
      ...
      activationScripts = import ../lib/activation.nix {
        ...
        wrapScript = script: ''
          ${script}
          chown -R ${lib.escapeShellArg cfg.user}:${lib.escapeShellArg null} "${homeDir}/Library/Application Support/Vencord" || true
          chown -R ${lib.escapeShellArg cfg.user}:${lib.escapeShellArg null} "${homeDir}/Library/Application Support/discord" || true
          chown -R ${lib.escapeShellArg cfg.user}:${lib.escapeShellArg null} "${homeDir}/Library/Application Support/discordptb" || true
          chown -R ${lib.escapeShellArg cfg.user}:${lib.escapeShellArg null} "${homeDir}/Library/Application Support/discordcanary" || true
          chown -R ${lib.escapeShellArg cfg.user}:${lib.escapeShellArg null} "${homeDir}/Library/Application Support/discorddevelopment" || true
          chown -R ${lib.escapeShellArg cfg.user}:${lib.escapeShellArg null} "${homeDir}/Library/Application Support/vesktop" || true
          chown -R ${lib.escapeShellArg cfg.user}:${lib.escapeShellArg null} "${homeDir}/Library/Application Support/equibop" || true
          chown -R ${lib.escapeShellArg cfg.user}:${lib.escapeShellArg null} "${homeDir}/.config/dorion" || true
        '';
      };
